...
<div class="cv-hero">
  <div class="cv-hero-text">
    ...
    <div class="cv-contact">
      <span>Lymington, UK</span>
      <span class="cv-sep">&middot;</span>
      <a href="mailto:cjcharrison@gmail.com">cjcharrison@gmail.com</a>
      <span class="cv-sep">&middot;</span>
      <a href="https://analytax.ai">analytax.ai</a>
    </div>
  </div>
  <div class="cv-stats">
    ...
    <div class="cv-stat">
      <div class="cv-stat-number">20+</div>
      <div class="cv-stat-label">Markets Covered</div>
    </div>
    <div class="cv-stat">
      <div class="cv-stat-number">CTA</div>
      <div class="cv-stat-label">Chartered Tax Adviser</div>
    </div>
    <div class="cv-stat">
      <div class="cv-stat-number">1st</div>
      <div class="cv-stat-label">BSc Physics, Exeter</div>
    </div>
  </div>
</div>
...
<div class="cv-dashboard">
  ...
  <div class="cv-section-label">What I Do</div>
  ...
  <div class="cv-card">
    <div class="cv-card-header" onclick="toggleCvCard(this)">
      <h3>Tax Reporting &amp; Compliance</h3>
      <span class="cv-toggle">&#9660;</span>
    </div>
    <div class="cv-card-summary">
      <p>Tax reporting, account statements, transaction exports, audit trails and controls in highly regulated, multi-market environments.</p>
    </div>
    <div class="cv-card-detail">
      <ul>
        <li>Involved across all aspects of the Group Tax reporting function</li>
        <li>Compliance, risk management, management reporting and ad-hoc analysis</li>
        <li>Multi-market regulatory frameworks and cross-border compliance</li>
        <li>Transfer pricing documentation and tax authority responses</li>
      </ul>
    </div>
  </div>
  ...
  <div class="cv-card">
    ...
    <div class="cv-card-summary">
      <p>Vendor evaluation, integration and management. Coordinating global teams, shared-services and Big&nbsp;4 advisory relationships.</p>
    </div>
    <div class="cv-card-detail">
      <ul>
        <li>Led evaluation and integration of Alteryx, MS Power Platform</li>
        <li>Managed vendor relationships and performance for reporting tooling</li>
        <li>Coordinated VOIS shared services and external advisors (KPMG)</li>
        <li>Global stakeholder management across 20+ markets</li>
      </ul>
    </div>
  </div>

  <div class="cv-section-label">Career Timeline</div>

  <div class="cv-timeline-container">
    <div class="cv-timeline-line"></div>

    <!-- Present: Vodafone Group Services -->
    <div class="cv-tl-node active">
      ...
      <div class="cv-tl-card">
        ...
        <div class="cv-tl-detail">
          ...
          <ul>
            <li>Led vendor evaluation of automation tooling (Alteryx, MS Power Platform) for reporting and compliance workflows</li>
            <li>Promoted change and a data-driven culture, embedding continuous learning across global tax teams</li>
            <li>Hosted Vodafone&rsquo;s Global Tax Conference themed on tax data management</li>
            <li>Drove adoption across 20+ local markets through training, webinars and a community of advocates</li>
            <li>Partnered with design to improve reporting UX across internal web applications</li>
          </ul>
        </div>
      </div>
    </div>

    <!-- ITR Speaker milestone -->
    ...
    <!-- Data Business Practitioner milestone -->
    <div class="cv-tl-node milestone">
      <div class="cv-tl-dot"></div>
      <div class="cv-tl-milestone-card">
        <div class="cv-tl-role">Data Business Practitioner Level 2</div>
        <div class="cv-tl-org">Vodafone University &lsquo;Love Data&rsquo; programme</div>
      </div>
    </div>

    <!-- Vodafone Business / International Tax Manager -->
    <div class="cv-tl-node">
      <div class="cv-tl-dot"></div>
      <div class="cv-tl-card">
        <div class="cv-tl-head" onclick="toggleCvTl(this)">
          <div class="cv-tl-head-left">
        ...
        <div class="cv-tl-detail">
          ...
          <ul>
            ...
            <li>Delivered tax training to legal and commercial teams</li>
            <li>Involved in graduate recruitment</li>
          </ul>
          ...
          <p class="cv-sub-label">M&amp;A &amp; Transactions</p>
          <ul>
            <li>M&amp;A due diligence and post-acquisition tax integration and restructuring</li>
            <li>Involvement in transformational projects across the business</li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="cv-tl-node">
      ...
      <div class="cv-tl-card">
        <div class="cv-tl-head" onclick="toggleCvTl(this)">
          <div class="cv-tl-head-left">
            <div class="cv-tl-role">Corporate Tax Director</div>
            <div class="cv-tl-org">PKF Francis Clark, Poole</div>
          </div>
          <span class="cv-tl-dates">Jun &ndash; Oct 2017</span>
          <span class="cv-tl-toggle">&#9660;</span>
        </div>
        <div class="cv-tl-summary">Head of Corporate Tax across Poole, New Milton and Salisbury offices. Led the Innovation Taxes practice for the firm.</div>
        <div class="cv-tl-detail">
          <ul>
            <li>Head of Corporate Tax in Poole, New Milton and Salisbury</li>
            <li>Head of and development of Innovation Taxes (R&amp;D tax reliefs, Patent Box) for PKF Francis Clark</li>
            <li>Corporate tax business development</li>
            <li>Led a team of c.15 corporate tax specialists</li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="cv-tl-node">
      ...
      <div class="cv-tl-card">
        <div class="cv-tl-head" onclick="toggleCvTl(this)">
          <div class="cv-tl-head-left">
            <div class="cv-tl-role">R&amp;D Tax Manager</div>
            <div class="cv-tl-org">Deloitte, Reading &amp; London</div>
          </div>
          <span class="cv-tl-dates">Jan 2013 &ndash; Nov 2014</span>
          <span class="cv-tl-toggle">&#9660;</span>
        </div>
        <div class="cv-tl-summary">Project managed complex R&amp;D tax relief claims for FTSE 250 and large corporate groups.</div>
        <div class="cv-tl-detail">
          <ul>
            <li>Project management of teams to prepare and deliver complex R&amp;D tax relief claims for FTSE 250 groups</li>
            <li>Complex analysis of large data sets to identify expenditure qualifying for tax relief</li>
            <li>Business development activities targeting private markets in relation to R&amp;D Expenditure Credits and Patent Box</li>
            <li>Preparation and delivery of seminar presentations and webinars on R&amp;D tax reliefs and Patent Box</li>
            <li>Member of the Treasury R&amp;D consultative committee; actively involved in government consultations on the R&amp;D Expenditure Credit regime</li>
            <li>Regular author of articles for the Tax Journal on R&amp;D Expenditure Credits</li>
            <li>Involved in Deloitte response to the Budget</li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="cv-tl-node">
      ...
      <div class="cv-tl-card">
        <div class="cv-tl-head" onclick="toggleCvTl(this)">
          <div class="cv-tl-head-left">
            <div class="cv-tl-role">Tax Trainee &rarr; R&amp;D Tax Manager</div>
            <div class="cv-tl-org">Grant Thornton, Poole &rarr; Southampton &rarr; Oxford</div>
          </div>
          <span class="cv-tl-dates">Apr 2005 &ndash; Dec 2012</span>
          <span class="cv-tl-toggle">&#9660;</span>
        </div>
        <div class="cv-tl-summary">Progressed from tax trainee to R&amp;D Tax Manager over 7 years across three offices. Included a 5-month secondment at Ernst &amp; Young.</div>
        <div class="cv-tl-detail">
          <p class="cv-sub-label">R&amp;D Tax Manager &mdash; Oxford (Nov 2007 &ndash; Dec 2012)</p>
          <ul>
            <li>Member of the national R&amp;D tax practice</li>
            <li>Member of the Treasury R&amp;D consultative committee; involved in government consultation on ATL tax credit</li>
            <li>Member of core Patent Box team for Grant Thornton</li>
            <li>Project management of large company R&amp;D tax relief claims including FTSE 100 groups</li>
            <li>Development of close working relationships with individuals across multiple group companies including group tax managers</li>
            <li>Authored articles in the Tax Journal, most recently on FA 2012 R&amp;D changes</li>
            <li>Shortlisted in Lexis Nexis Taxation Awards for &lsquo;best tax team&rsquo; in a large firm</li>
            <li>Extensive use of Excel to analyse large data sets</li>
            <li>Line management responsibilities</li>
          </ul>
          <p class="cv-sub-label">R&amp;D Tax Specialist &mdash; Ernst &amp; Young (Jun &ndash; Nov 2007)</p>
          <ul>
            <li>Preparation of R&amp;D Tax Relief claims for large Plc clients</li>
            <li>Extensive data analysis and sampling methods to arrive at eligible expenditure</li>
            <li>Preparation of technical reports to support claims</li>
          </ul>
          <p class="cv-sub-label">Assistant Manager, Tax Advisory &mdash; Southampton (2007)</p>
          <ul>
            <li>Employer solutions and share schemes (EMI)</li>
            <li>Capital gains tax planning &mdash; Entrepreneurs&rsquo; Relief, PPR, EIS</li>
            <li>Inheritance tax planning &mdash; BPR, trusts, PETs</li>
            <li>HMRC clearance applications, investigations and negotiations</li>
            <li>Profit extraction &mdash; incorporation, reconstructions</li>
          </ul>
          <p class="cv-sub-label">Tax Trainee / Tax Senior &mdash; Poole (Apr 2005 &ndash; May 2007)</p>
          <ul>
            <li>Preparation and submission of personal and corporate tax returns and computations</li>
            <li>P11D preparation; trained new starters and placement students</li>
            <li>Tax Software Champion</li>
          </ul>
        </div>
      </div>
    </div>

    <!-- Tax Journal milestone -->
    <div class="cv-tl-node milestone">
      <div class="cv-tl-dot"></div>
      <div class="cv-tl-milestone-card">
        <div class="cv-tl-role">Published author &mdash; Tax Journal</div>
        <div class="cv-tl-org">Multiple articles on R&amp;D tax reliefs and Patent Box</div>
      </div>
    </div>
      ...
      <div class="cv-tl-card">
        ...
        <div class="cv-tl-detail">
          <ul>
            ...
            <li>Security clearance to work on sensitive projects under the Official Secrets Act</li>
            <li>Advanced use of Excel in modelling and analysing data</li>
            <li>Collaborated with academic and government research partners</li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="cv-tl-node milestone">
      <div class="cv-tl-dot"></div>
      <div class="cv-tl-milestone-card">
        <div class="cv-tl-role">BSc (Hons) Physics &mdash; First Class</div>
        <div class="cv-tl-org">University of Exeter &middot; 1999 &ndash; 2002</div>
      </div>
    </div>
    ...
    <div class="cv-tl-node milestone">
      <div class="cv-tl-dot"></div>
      <div class="cv-tl-milestone-card">
        <div class="cv-tl-role">A-levels: Maths (A), Physics (B), Biology (C)</div>
        <div class="cv-tl-org">Woodroffe School, Lyme Regis &middot; 1991 &ndash; 1999</div>
      </div>
    </div>

  </div>

  <div class="cv-section-label">Speaking, Writing &amp; Technology</div>
  ...
  <!-- Qualifications -->
  <div class="cv-card cv-full-width">
    <div class="cv-card-header">
    ...
    <div class="cv-quals-list">
      ...
      <div class="cv-qual-row">
        ...
        <span class="cv-qual-detail">University of Exeter</span>
      </div>
      <div class="cv-qual-row">
        <span class="cv-qual-title">Data Business Practitioner Level 2</span>
        <span class="cv-qual-detail">Vodafone University</span>
      </div>
    </div>
  </div>
...
<div class="cv-cta">
  <div class="cv-cta-inner">
    ...
    <p>Interested in tax technology, analytics or anything on the blog? I&rsquo;d love to hear from you.</p>
    <a href="mailto:cjcharrison@gmail.com" class="cv-cta-btn">Get in Touch</a>
  </div>
</div>

<script>
function toggleCvCard(header) {
  var card = header.closest('.cv-card');
  var detail = card.querySelector('.cv-card-detail');
  if (!detail) return;
  var isOpen = detail.classList.contains('open');
  var allDetails = document.querySelectorAll('.cv-card-detail.open');
  for (var i = 0; i < allDetails.length; i++) {
    allDetails[i].classList.remove('open');
    allDetails[i].closest('.cv-card').querySelector('.cv-card-header').classList.remove('open');
  }
  if (!isOpen) {
...
function toggleCvTl(head) {
  var card = head.closest('.cv-tl-card');
  var detail = card.querySelector('.cv-tl-detail');
  if (!detail) return;
  var isOpen = detail.classList.contains('open');
  var allDetails = document.querySelectorAll('.cv-tl-detail.open');
  for (var i = 0; i < allDetails.length; i++) {
    allDetails[i].classList.remove('open');
    allDetails[i].closest('.cv-tl-card').querySelector('.cv-tl-head').classList.remove('open');
  }
  if (!isOpen) {
    detail.classList.add('open');
